...
public class BookController {
	...
	public @ResponseBody StateResult updateBook(@RequestBody Book book,HttpSession session)  {
	...
	public @ResponseBody StateResult addBook(@RequestBody Book book, HttpSession session) {
