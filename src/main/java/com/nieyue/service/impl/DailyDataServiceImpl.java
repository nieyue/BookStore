...
public class DailyDataServiceImpl implements DailyDataService{
	...
	@Override
	public DailyData loadDailyData(Integer dailyDataId,Date createDate,Integer bookId,Integer acountId) {
		DailyData r = dailyDataDao.loadDailyData(dailyDataId,createDate,bookId,acountId);
		return r;
	}

	@Override
	public int countAll(Date createDate,Integer bookId,Integer acountId) {
		int c = dailyDataDao.countAll(createDate,bookId,acountId);
		return c;
	}

	@Override
	public List<DailyData> browsePagingDailyData(Date createDate,Integer bookId,Integer acountId,int pageNum, int pageSize,
		...
		List<DailyData> l = dailyDataDao.browsePagingDailyData(createDate,bookId,acountId,pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
	@Override
	...
	@Override
	public List<DailyData> statisticsDailyData(Date startDate,Date endDate, Integer bookId,Integer acountId, int pageNum, int pageSize,
			String orderName, String orderWay) {
		if(pageNum<1){
			pageNum=1;
		}
		...
		List<DailyData> l = dailyDataDao.statisticsDailyData(startDate,endDate, bookId, acountId, pageNum-1, pageSize, orderName, orderWay);
		return l;
	}
